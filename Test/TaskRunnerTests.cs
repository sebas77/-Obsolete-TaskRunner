...
namespace Test
{
    ...
    public class TaskRunnerTests
    {
        ...
        public void SingleTask()
        {
            ...
            task.onComplete += () => { test1Done = true; };
        ...
        public void SerialITasks()
        {
            ...
            task.onComplete += () => { test1Done = true; Assert.That(test2Done == false); };

            serialTasks.Add(task);

            task = new Task();

            task.onComplete += () => { test2Done = true; Assert.That(test1Done == true); };

            serialTasks.Add(task);
            serialTasks.onComplete += () => { allDone = true; };
        ...
        public void ParallelITasks()
        {
            ...
            task.onComplete += () => { test2Done = true; };

            parallelTasks.Add(task);
            parallelTasks.onComplete += () => { allDone = true; };
        ...
        public void SerialParallelEnumerable()
        {
            ...
            parallelTasks1.Add(task);
            parallelTasks1.onComplete += () => { parallelTasks1Done = true; Assert.That(parallelTasks2Done == false); };
            ...
            parallelTasks2.Add(task);
            parallelTasks2.onComplete += () => { parallelTasks2Done = true; Assert.That(parallelTasks1Done == true); };
